...
public class TunerConstants {
  ...
  public static final CANBus kCANBus = new CANBus("CANIVORE 3", "./logs/example.hoot");

  // Theoretical free speed (m/s) at 12 V applied output;
  // This needs to be tuned to your individual robot
  public static final LinearVelocity kSpeedAt12Volts =
      MetersPerSecond.of(
          5.284); // theoretical 12V speed. Empirical testing shows 4.8m/s at 10.9V max (battery
  // drain)
  ...
  private static final MomentOfInertia kDriveInertia = KilogramSquareMeters.of(.03);
  ...
  private static final Angle kFrontRightEncoderOffset = Rotations.of(0.435349609375);
  ...
  private static final Angle kBackLeftEncoderOffset = Rotations.of(0.034958984375);
